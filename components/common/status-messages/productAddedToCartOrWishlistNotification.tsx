...
import { clearNotification } from "@/state/features/notification/productAddedToCartOrWishlistNotification";
export const ProductAddedToCartOrWishlistNotification = () => {
  const dispatch = useAppDispatch();
  const notification = useAppSelector(
    (state) => state.productAddedToCartOrWishlistNotification,
  );
  useEffect(() => {
